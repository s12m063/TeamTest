	...
	<div class="page mt3">
		...
		<input type="hidden" name="csrf" value="${sessionScope.CSRF_TOKEN}">
			<div class="mb3">
				...
				<input
					class="form-control" id="dname" name="dname" placeholder="dname" />
			</div>
			<div class="mb3">
				<label for="loc" class="form-label">loc</label> <input
					class="form-control" id="loc" name="loc" placeholder="loc" />
			</div>
			<div class="mb3">
